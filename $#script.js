...
function searchMembers() {
    ...
    const allMembers = loadMembers(); // Ambil semua anggota untuk lookup
    ...
    displaySearchResults(results.reverse(), allMembers); // Kirim 'allMembers' untuk lookup
}

// ==========================================================
// === FUNGSI INI DIUBAH (displaySearchResults) ===
// ==========================================================
function displaySearchResults(results, allMembers) { // Terima 'allMembers'
    ...
    // Masukkan semua kartu HTML ke dalam kontainer
...
// --- NETWORK VISUALIZATION (Tidak Diubah) ---
