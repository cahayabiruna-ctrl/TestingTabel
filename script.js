...
function initializeDashboard() {
    // ... (Fungsi initializeDashboard tidak berubah) ...
    updateCount();
...
// ==========================================================
// === FUNGSI BARU UNTUK DOWNLOAD GAMBAR JARINGAN ===
// ==========================================================
/**
 * Membuat gambar dari diagram jaringan dan mengunduhnya sebagai file PNG.
 */
function downloadNetworkImage() {
    ...
    try {
        ...
        const link = document.createElement('a');
        link.href = img.src; // img.src adalah data URL (base64)
        link.download = 'struktur_jaringan_dvteam.png'; // Nama file
        
        // Klik link secara programatik dan hapus
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
